...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/05 21:29:48 by knaumov           #+#    #+#             */
/*   Updated: 2019/06/05 21:29:49 by knaumov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				julia(t_point pixel, t_fractol *fractol)
{
	...
	constant.x = (double)(fractol->mouse.pos.x - \
					WIN_WIDTH / 2) / fractol->zoom;
	constant.y = (double)(fractol->mouse.pos.y - \
					WIN_HEIGHT / 2) / fractol->zoom;
