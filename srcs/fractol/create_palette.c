...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/05 21:10:30 by knaumov           #+#    #+#             */
/*   Updated: 2019/06/05 21:10:31 by knaumov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

void		assign_psychedelic_continue(t_fractol *fractol)
{
...
void		assign_psychedelic(t_fractol *fractol)
{
	...
	assign_psychedelic_continue(fractol);
}
